...
import { Trophy, Search, RefreshCw, Clock, Target, Zap } from 'lucide-react';
...
export default function CompetitionsPage() {
  ...
  const handleFiltersChange = (newFilters: Filters) => {
    setFilters({ ...newFilters, type: 'competition' });
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-br from-orange-50 via-background to-amber-50 dark:from-orange-950/20 dark:via-background dark:to-amber-950/20 py-12">
          <div className="container">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Test your skills in coding contests and challenges</p>
              </div>
            </div>

            <div className="flex flex-wrap gap-3 mt-6">
              <Badge variant="outline" className="bg-orange-50 dark:bg-orange-950/30">
                <Target className="h-3 w-3 mr-1" /> Competitive programming
              </Badge>
              <Badge variant="outline" className="bg-orange-50 dark:bg-orange-950/30">
                <Clock className="h-3 w-3 mr-1" /> Timed challenges
              </Badge>
              <Badge variant="outline" className="bg-orange-50 dark:bg-orange-950/30">
                <Zap className="h-3 w-3 mr-1" /> Rank-based scoring
              </Badge>
            </div>
          </div>
        </section>
        ...
        <section className="py-6 border-b bg-muted/20">
          <div className="container">
            <OpportunityFilters filters={filters} onFiltersChange={handleFiltersChange} opportunityType="competition" />
          </div>
        </section>
        ...
        <section className="py-8">
          <div className="container">
            {loading && opportunities.length === 0 ? (
              ...
              <>
                <p className="text-sm text-muted-foreground mb-6">Showing {opportunities.length} competitions</p>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
