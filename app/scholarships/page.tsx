...
import { GraduationCap, Search, RefreshCw, DollarSign, Globe, BookOpen } from 'lucide-react';
...
export default function ScholarshipsPage() {
  ...
  const handleFiltersChange = (newFilters: Filters) => {
    setFilters({ ...newFilters, type: 'scholarship' });
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-br from-rose-50 via-background to-pink-50 dark:from-rose-950/20 dark:via-background dark:to-pink-950/20 py-12">
          <div className="container">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Financial support for your educational journey</p>
              </div>
            </div>

            <div className="flex flex-wrap gap-3 mt-6">
              <Badge variant="outline" className="bg-rose-50 dark:bg-rose-950/30">
                <DollarSign className="h-3 w-3 mr-1" /> Full & partial funding
              </Badge>
              <Badge variant="outline" className="bg-rose-50 dark:bg-rose-950/30">
                <Globe className="h-3 w-3 mr-1" /> International opportunities
              </Badge>
              <Badge variant="outline" className="bg-rose-50 dark:bg-rose-950/30">
                <BookOpen className="h-3 w-3 mr-1" /> Academic excellence
              </Badge>
            </div>
          </div>
        </section>
        ...
        <section className="py-6 border-b bg-muted/20">
          <div className="container">
            <OpportunityFilters filters={filters} onFiltersChange={handleFiltersChange} opportunityType="scholarship" />
          </div>
        </section>
        ...
        <section className="py-8">
          <div className="container">
            {loading && opportunities.length === 0 ? (
              ...
              <>
                <p className="text-sm text-muted-foreground mb-6">Showing {opportunities.length} scholarships</p>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
